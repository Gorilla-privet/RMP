...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Дата через 10 дней: " + dateFormatter.addDaysToDate("01-01-2025"));

        // 8. Конвертация между часовыми поясами
        TimeZoneConverter timeZoneConverter = new TimeZoneConverter();
        System.out.println("Дата и время в Москве: " + timeZoneConverter.convertTimeZone("2025-01-01", "12:00:00"));

        // 9. Вычисление возраста по дате рождения
        AgeCalculator ageCalculator = new AgeCalculator();
        LocalDate birthDate = LocalDate.of(2006, 8, 11);
        ...
        LocalDateTime eventDateTime = LocalDateTime.of(2025, 8, 11, 0, 0);
